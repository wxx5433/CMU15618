...
template <typename T>
void _cmu418_swizzle(__cmu418_vec<T> &vecResult, __cmu418_vec<T> &vec) {
  for (int i=0; i<VECTOR_WIDTH; i++) {
...
template void _cmu418_swizzle<float>(__cmu418_vec_float &vecResult, __cmu418_vec_float &vec);

void _cmu418_swizzle_float(__cmu418_vec_float &vecResult, __cmu418_vec_float &vec) { _cmu418_swizzle<float>(vecResult, vec); }
