...
// Performs an even-odd swizzle where all even-indexed elements move to front half
//  of the array and odd-indexed to the back half, so [0 1 2 3] -> [0 2 1 3]
void _cmu418_swizzle_float(__cmu418_vec_float &vecResult, __cmu418_vec_float &vec);
